...
const blueprintTempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'evolink-kfgen-mcp-blueprints-'));
const gateTempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'evolink-kfgen-mcp-gates-'));
const envVars = {
